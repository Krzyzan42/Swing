...
using PathCreator.Core.Editor.Helper;
using PathCreator.Core.Runtime.Objects;
using PathCreator.Core.Runtime.Utility;
using UnityEditor;
using UnityEditor.IMGUI.Controls;
using UnityEngine;
using UnityEngine.Rendering;

namespace PathCreator.Core.Editor
{
    ...
    public class PathEditor : UnityEditor.Editor
    {
        ...
        // References:
        private Runtime.Objects.PathCreator creator;
        private UnityEditor.Editor globalDisplaySettingsEditor;
